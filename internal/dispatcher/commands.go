...
const (
	...
	SingleGptMessageCommand Command = "gpt"
)

var globalCommandList = []Command{
...
var constantReplies = map[Command]string{
	...
	HelpCommand:  fmt.Sprintf("Список команд: \n%s", strings.Join(buildCommandList(globalCommandList), "\n")),
}

func buildCommandList(commands []Command) []string {
